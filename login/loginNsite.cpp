...
#define HTTP_methoods SimpleHTTPConstruct::SimpleHTTPConstruct
    ...
    void siteLogicRun(std::string input) {
        ...
        std::wcout << HTTP_methoods::Paragrah(L"align = \"center\"", 
            HTTP_methoods::Form(L"METHOD = \"POST\" action = AeroPhlot.cgi", 
                ...
                HTTP_methoods::Select(L"name=\"Arrive\"", { L"Moscow", L"Samara", L"Krasnoyarsk", L"Ulyanovsk", L"Saint-Peterburg", L"Rostov-na-Donu", L"Volgograd", L"Sochi", L"Kazan", L"Saratov", L"Novosibirsk" }) + L"<br><br>" +
    ...
    int main() {
        ...
        if (getenv("REQUEST_METHOD") != "GET" && action == "/cgi-bin/AeroPhlot.cgi") {
